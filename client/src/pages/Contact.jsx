    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6 '>
          ...
          <p className='text-gray-500'>Sri shakthi Institute of Engineering and Technology <br /> Coimbatore, Tamilnadu</p>
          <p className='text-gray-500'>Tel: (+91) 9750117776<br />Email: Krishna@gmail.com</p>
